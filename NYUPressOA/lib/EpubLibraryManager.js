define(['jquery', 'module', 'PackageParser', 'workers/WorkerProxy', 'storage/StorageManager', 'i18n/Strings'], function($, module, PackageParser, WorkerProxy, StorageManager, Strings) {
    ...
    LibraryManager.prototype = {
        _getFullUrl: function(packageUrl, relativeUrl) {
            ...
            console.log("LMH in _getFullUrl: packageUrl is " + packageUrl + "  relativeUrl " + relativeUrl);
        ...
        retrieveAvailableEpubs: function(success, error) {
            ...
            console.log("**LMH  retrieveAvailableEpubs " + indexUrl);
            if (this.libraryData) {
                console.log("**LMH  already has data **");
            ...
            $.getJSON(indexUrl, function(data) {
                ...
                console.log("**LMH  success **" + data[0].description);
                //console.trace(data);
            }).fail(function() {
                self.libraryData = [];
                success([]);
                console.log("**LMH  fail to get JSON **");
            });
        },
        ...
        retrieveFullEpubDetailsFromJSON: function(epubs, id) {
            a = _.find(epubs, function(rw) {
                return rw.packageUrl == id;
            });
            console.log(" retrieveFullEpubDetailsFromJSON " + id);
            return a;
        },
        retrieveFullEpubDetails: function(packageUrl, success, error) {
            console.log(" retrieveFullEpubDetails packageUrl" + packageUrl);
            var self = this;
            $.get(packageUrl, function(data) {
                ...
                jsonObj.thisHandleUrl = packageUrl;
