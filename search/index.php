...
<head>
  ...
  <script id="list-template" type="text/x-handlebars-template">
      ...
      <div class="library-item">
        <div class="img_hold">
          <a class="item-link" href="http://dev-dl-pa.home.nyu.edu/nyupress-epubs-site/details/{{identifier}}"><img class="img-responsive" src="http://dev-dl-pa.home.nyu.edu/nyupress-epubs-site/NYUPressOA/{{thumbHref}}" alt="" title="{{title}}"/></a>
        </div>
        <div class="book-info">
          <h4 class="book-title"><a class="item-link" href="http://dev-dl-pa.home.nyu.edu/nyupress-epubs-site/details/{{identifier}}">{{title}}</a></h4>
...
<body class="list-view search" data-app="http://dev-dl-pa.home.nyu.edu/nyupress-epubs-site" data-discovery="http://discovery.dlib.nyu.edu:8080/solr3_discovery/nyupress">
   <div class="header">
  ...
  <div class="breadcrumb">
    <span class="page-title"><a href="http://dev-dl-pa.home.nyu.edu/nyupress-epubs-site">Home</a> &gt; Search &gt; <span class="query"></span></span>
  </div>
