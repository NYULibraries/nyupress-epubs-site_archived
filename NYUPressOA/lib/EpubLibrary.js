    ...
    function($, bootstrap, StorageManager, libraryManager, Strings, LibraryNavbar, LibraryBody, LibraryItem, DetailsDialog, DetailsBody,
        ...
        var loadLibraryItems = function(epubs) {
            ...
            epubs.forEach(function(epub) {
                // console.trace(epub);
                $('.library-items').append(LibraryItem({
                    epub: epub,
                    strings: Strings
                }));
            });
            $('.details').on('click', function(e) {
                ...
                // xmlurl = $this.attr('data-book') + '/META-INF/container.xml';
                // console.trace("url " + url);
                // console.trace("xmlurl " + xmlurl);
                var $metaPath = url;
                $('.details-dialog').remove();
                $('#app-container').append(detailsDialogStr);
                $('.details-dialog').modal();
                libraryManager.retrieveFullEpubDetails($metaPath, showDetailsDialog, showError);
            });
        };
        ...
        var loadLibraryUI = function() {
            ...
            $('#app-container').css('overflowY', 'scroll');
